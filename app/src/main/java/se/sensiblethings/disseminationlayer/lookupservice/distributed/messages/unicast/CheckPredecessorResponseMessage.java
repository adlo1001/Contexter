...
public class CheckPredecessorResponseMessage extends Message {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4625402381316760219L;
	private SensibleThingsNode preNetworkNode;
	private NodeID preHash;

	public CheckPredecessorResponseMessage(SensibleThingsNode fromNode, SensibleThingsNode toNode, SensibleThingsNode preNetworkNode, NodeID preHash) {
		super(fromNode, toNode);
		this.preNetworkNode = preNetworkNode;
		this.preHash = preHash;
	}

	public SensibleThingsNode getPreNetworkNode() {
	...
	public String toString() {
		// Return message info
		return super.toString()	+ " | preHash: " + preHash.toString() + " preAddr: (" + preNetworkNode.toString() + ")";
	}
