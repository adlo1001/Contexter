...
public class RegisterResponseMessage extends Message {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2940053106162661067L;
	private NodeID sensor;
	private NodeID origHash;

	public RegisterResponseMessage(SensibleThingsNode fromNode, SensibleThingsNode toNode, NodeID sensor, NodeID origHash) {
	...
	public String toString() {
		// Return message info
		return super.toString() + " sensor: " + sensor + " - origHash: " + origHash;
	}
