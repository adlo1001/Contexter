...
public class Join extends DHTMessage {

	/**
	 * 
	 */
	private static final long serialVersionUID = -5344826405613129593L;
	private FingerEntry identity;

	public Join(SensibleThingsNode fromNode, SensibleThingsNode toNode,
			String ring, FingerEntry identity) {
