...
public class JoinAckMessage extends Message {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2886337772155673973L;
	private NodeID joinKey;

	public JoinAckMessage(SensibleThingsNode fromNode, SensibleThingsNode toNode, NodeID joinKey) {
