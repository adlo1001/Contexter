...
public class Leave extends DHTMessage {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4625301085049550246L;
	private FingerEntry predecessor;

	public Leave(SensibleThingsNode fromNode, SensibleThingsNode toNode,
			String ring, FingerEntry predecessor) {
