...
public class NodeSuspiciousMessage extends Message {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1388647141644892209L;
	private NodeID hash;

	public NodeSuspiciousMessage(SensibleThingsNode fromNode, SensibleThingsNode toNode, NodeID hash) {
