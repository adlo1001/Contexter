...
public class CheckSuccessorMessage extends Message {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3309225736694436099L;
	private NodeID hash;

	public CheckSuccessorMessage(SensibleThingsNode fromNode, SensibleThingsNode toNode, NodeID hash) {
