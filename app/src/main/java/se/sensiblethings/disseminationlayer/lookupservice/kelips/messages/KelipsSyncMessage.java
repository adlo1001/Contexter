...
public class KelipsSyncMessage extends Message {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1216205642662185883L;
	
	ConcurrentHashMap<String, TimestampedNode> lookupTable = new ConcurrentHashMap<String, TimestampedNode>();
	int groupNumber;
	
	public KelipsSyncMessage(SensibleThingsNode fromNode, SensibleThingsNode toNode, int groupNumber, ConcurrentHashMap<String, TimestampedNode> lookupTable) {
